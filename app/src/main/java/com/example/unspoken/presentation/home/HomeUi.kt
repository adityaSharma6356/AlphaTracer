package com.example.unspoken.presentation.home
...
import com.example.unspoken.presentation.home.main_feed.MainFeedUi
...
//                        .padding(start = 20.dp)
//                        .background(MaterialTheme.colorScheme.surface.copy(alpha = 0.1f), RoundedCornerShape(20.dp))
                    ) {
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Column {
                                Text(text = "Ben Dover", fontSize = 25.sp, color = MaterialTheme.colorScheme.surface, fontFamily = mainFont, modifier = Modifier)
                                Text(text = "bendover@adgitmdelhi.ac.in", fontSize = 15.sp, color = MaterialTheme.colorScheme.surface.copy(alpha = 0.6f), maxLines = 1, overflow = TextOverflow.Ellipsis)
                            }
                        }
                        Spacer(
                            modifier = Modifier
...
fun SideNavMenuText(text: String, fontSize: TextUnit = 25.sp, onCLick: () -> Unit = {}, icon: @Composable () -> Unit = {}) {
    Box(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Text(text = text, fontSize = fontSize, color = MaterialTheme.colorScheme.surface, fontFamily = mainFont, modifier = Modifier)
        }
    }
}
